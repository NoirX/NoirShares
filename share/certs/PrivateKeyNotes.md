...
unlocked to sign the NoirShares-Qt.app bundle.
...
allowing somebody to distribute a NoirShares-Qt.app or noirshares-qt-setup.exe with a valid
...
that the noirshares-qt.exe file inside the installer had not been tampered with.
