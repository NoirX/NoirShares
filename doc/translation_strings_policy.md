...
This document provides guidelines for internationalization of the NoirShares Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `noirshares_en.ts` remains unchanged.
