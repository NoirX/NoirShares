NoirShares-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/noirshares/files/NoirShares/noirshares-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the NoirShares
...
New/changed settings (command-line or noirshares.conf file)
--------------------------------------------------------
