NoirShares Core version 0.9.2.1 is now available from:

  https://noirshares.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 NRS to 0.01 NRS
...
- Fix "Start noirshares on system login"
