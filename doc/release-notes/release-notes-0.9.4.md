NoirShares Core version 0.9.4 is now available from:

  https://noirshares.org/bin/0.9.4/
...
this update is incompatible with the NoirShares system and could lead to consensus
forks.

NoirShares Core released binaries from https://noirshares.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~noirshares/+archive/ubuntu/noirshares
- A third-party or self-compiled NoirShares Core

upgrade to NoirShares Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
