NoirShares Core version 0.10.4 is now available from:

  <https://noirshares.org/bin/noirshares-core-0.10.4/>
...
- #6953 `43c2789` Split noirshares-tx into its own package
- #6953 `dfe0d4d` Include noirshares-tx binary on Debian/Ubuntu
