NoirShares version 0.5.4 is now available for download at:
http://sourceforge.net/projects/noirshares/files/NoirShares/noirshares-0.5.4/
...
http://gitorious.org/noirshares/noirsharesd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix NoirShares-Qt notifications under Growl 1.3.
Increase required age of NoirShares-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxNoirShares properly when installing NoirShares-Qt over it. (Windows)
