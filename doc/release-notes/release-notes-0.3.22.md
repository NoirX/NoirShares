Download URL: https://sourceforge.net/projects/noirshares/files/NoirShares/noirshares-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 NRS fee schedule (users still pay 0.01 NRS per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #noirshares00 - #noirshares99
