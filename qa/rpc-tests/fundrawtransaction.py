...
class RawTransactionsTest(NoirSharesTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid noirshares address")
        except JSONRPCException,e:
            assert("changeAddress must be a valid noirshares address" in e.error['message'])
