...
#ifndef NOIRSHARES_TEST_SCRIPTNUM10_H
#define NOIRSHARES_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from NoirShares Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // NOIRSHARES_TEST_BIGNUM_H
