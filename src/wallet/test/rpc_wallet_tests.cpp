// Copyright (c) 2013-2015 The NoirShares Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CNoirSharesAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CNoirSharesAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CNoirSharesAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CNoirSharesAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CNoirSharesAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CNoirSharesAddress(arr[0].get_str()).Get() == demoAddress.Get());
