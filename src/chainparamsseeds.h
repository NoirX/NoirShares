#ifndef NOIRSHARES_CHAINPARAMSSEEDS_H
#define NOIRSHARES_CHAINPARAMSSEEDS_H
/**
 * List of fixed seed nodes for the noirshares network
...
#endif // NOIRSHARES_CHAINPARAMSSEEDS_H
