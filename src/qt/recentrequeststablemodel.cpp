    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return NoirSharesUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, NoirSharesUnits::separatorNever);
            else
                return NoirSharesUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount);
        }
    }
...
{
    return (this->walletModel->getOptionsModel() != NULL) ? tr("Requested") + " ("+NoirSharesUnits::name(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
