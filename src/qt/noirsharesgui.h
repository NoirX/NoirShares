...
#ifndef NOIRSHARES_QT_NOIRSHARESGUI_H
#define NOIRSHARES_QT_NOIRSHARESGUI_H
...
public:
    ...
    explicit NoirSharesGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~NoirSharesGUI();
...
#endif // NOIRSHARES_QT_NOIRSHARESGUI_H
