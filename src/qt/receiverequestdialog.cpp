...
#include "config/noirshares-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatNoirSharesURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + NoirSharesUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatNoirSharesURI(info));
}
