...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/noirshares"));
     ...
     * override -datadir in the noirshares.conf file in the default data directory
     * (to be consistent with noirsharesd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
