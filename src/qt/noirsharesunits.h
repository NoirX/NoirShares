...
#ifndef NOIRSHARES_QT_NOIRSHARESUNITS_H
#define NOIRSHARES_QT_NOIRSHARESUNITS_H
...
public:
    ...
    /** NoirShares units.
      @note Source: https://en.noirshares.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        NRS,
...
#endif // NOIRSHARES_QT_NOIRSHARESUNITS_H
