...
// Copyright (c) 2009-2012 The NoirShares Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The NoirShares/$1-%s The NoirShares/' %s"
REGEX_CURRENT= re.compile("%s The NoirShares" % year)
